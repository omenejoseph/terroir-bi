...
class PriceController extends Controller
{
     ...
     */
    public function itemTierPrices(InventoryItem $item, ItemPricingQuery $query): JsonResponse
    {
        return response()->json(['data' => $query->tierPrices($item)]);
    }

    /**
     * Customer-specific price overrides for an item (customer → absolute price).
     */
    public function itemCustomerPrices(InventoryItem $item, ItemPricingQuery $query): JsonResponse
    {
        return response()->json(['data' => $query->customerOverrides($item)]);
    }
