...
/**
 * Renders the one-shot session flash shared by HandleInertiaRequests. Sits in
 * the layout so any controller can `->with('success', …)` on a redirect and
 * have it surface without touching the page component.
 */
